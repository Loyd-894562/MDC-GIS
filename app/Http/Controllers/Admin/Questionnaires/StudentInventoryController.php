    ...
    public function inventoryUpdate(Request $request, $id)
{
    ...
    $inventory->update($request->all()); // Update the inventory record with the submitted data
    return redirect('/admin/inventory')->with('message', 'inventory Form Updated!'); // Redirect to the index page or a success page
}
