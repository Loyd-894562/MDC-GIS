            ...
            <table class="min-w-full border border-gray-300">
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-2 bg-gray-100 border-b border-gray-300">Position</th>
                        <th class="px-4 py-2 bg-gray-100 border-b border-gray-300">Profile Image</th>
                ...
                <tbody>
                        ...
                        <tr class="hover:bg-gray-100 {{ $loop->iteration % 2 === 0 ? 'bg-gray-100' : '' }}">
                            ...
                            <td class="px-4 py-2 border-b border-gray-300">
                                ...
                                <div class="rounded-full overflow-hidden w-16 h-16">
                                    <img src="{{ asset('user_img/' . $user->profile_image) }}" alt="user Image" class="object-cover w-full h-full">
                                </div>
                            @else
                                No Image Available
                            @endif</td>
                    ...
                    <td class="px-4 py-2 border-b border-gray-300">{{ $user->position }}
